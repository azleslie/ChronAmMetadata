...
```{r}
#there should be 2663 observations remaining in data frame; if more, newspapers have been added to since last update
write.csv(paperdata, "clean_paperdata_oct18.csv")
```
